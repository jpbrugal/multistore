...
void main() async{
  ...
  await Firebase.initializeApp(
    options: kIsWeb || Platform.isAndroid ? (
      FirebaseOptions(
          apiKey: "AIzaSyCYUxA8XrK8UL6PzL-gWD8vbKQq4H5uvko",
          authDomain: "multi-store-admin-ac1b1.firebaseapp.com",
          projectId: "multi-store-admin-ac1b1",
          storageBucket: "multi-store-admin-ac1b1.appspot.com",
          messagingSenderId: "455843562232",
          appId: "1:455843562232:web:bc01270be0fba31893b10d"
      )
    ) : null
  );
  runApp(const MyApp());
